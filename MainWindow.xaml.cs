...
namespace GigaPrime3D
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            Chart3DSurface.PointerMoved += Chart_MouseMove;
            Chart3DSurface.PeCustomMenu += Chart_PeCustomMenu;
            Chart3DSurface.PeHorzScroll += Chart_OnPeHorzScroll;   // were XAML events in WPF; wired in code for WinUI
            Chart3DSurface.PeVertScroll += Chart_OnPeVertScroll;
            Chart3DSurface.PeZoomIn += Chart_OnPeZoomIn;

            Chart2DContour.PointerEntered += Chart2DContour_MouseEnter;
        ...
        {
            if (!Chart3DSurface.IsChartInitialized) { return; }  // Sanity check to make sure Pe3doWpf is loaded  
            ...
            try
            {
                ...
                // IsManipulationEnabled: WPF gesture flag -- WinUI chart forwards pointers itself
                ...
                Chart3DSurface.PeColor.GraphBackground = Color.FromArgb(255, 0x00, 0x2B, 0x35);
                Chart3DSurface.PeColor.Desk = Color.FromArgb(255, 0x00, 0x2B, 0x35); 
                Chart3DSurface.PeColor.GraphForeground = Microsoft.UI.Colors.White;
                Chart3DSurface.PeColor.ZAxis = Microsoft.UI.Colors.White;
                Chart3DSurface.PeColor.YAxis = Microsoft.UI.Colors.White;
                Chart3DSurface.PeColor.XAxis = Microsoft.UI.Colors.White;
                Chart3DSurface.PeColor.Text = Microsoft.UI.Colors.White;
                ...
                // WinUI render scheduling (WinUI-only property). This 3D chart is driven from the 2D CONTOUR's
                // zoom / scroll / undo handlers -- i.e. from an interaction on the OTHER control. Under the
                // default RenderPriority.Auto, only renders caused by a button-down on THIS control get Normal
                // priority; a render requested from another control's context stays Low and can lag or be
                // starved. That is why panning a zoomed contour trails here, and why a contour Undo-Zoom may
                // not repaint the 3D even though its handler ran. Forcing Normal keeps these cross-control
                // updates live (raise to High if you want it even snappier, at the risk of starving XAML input).
                Chart3DSurface.RenderPriority = PeRenderPriority.Normal;
        ...
        {
            if (!Chart2DContour.IsChartInitialized) { return; }  // Sanity check to make sure Pe3doWpf is loaded  
            ...
            Chart2DContour.IsTabStop = false; // false;
            Chart2DContour.PeColor.Desk = Color.FromArgb(255, 0x00, 0x2B, 0x35);
            Chart2DContour.PeColor.Text = Color.FromArgb(255, 255, 255, 255);
            Chart2DContour.PeColor.GraphBackground = Color.FromArgb(255, 0x00, 0x2B, 0x35);
        ...
        {
            if (!Chart2DLine.IsChartInitialized) { return; }  // Sanity check to make sure Pe3doWpf is loaded  
            ...
            Chart2DLine.IsTabStop = false;

            Chart2DLine.PeColor.Desk = Color.FromArgb(255, 0x00, 0x2B, 0x35); 
            Chart2DLine.PeColor.Text = Color.FromArgb(255, 255, 255, 255);
            Chart2DLine.PeColor.GraphBackground = Color.FromArgb(255, 0x00, 0x2B, 0x35);
            Chart2DLine.PeColor.GraphForeground = Microsoft.UI.Colors.White;
        ...
        private void Chart2DContour_MouseEnter(object sender, PointerRoutedEventArgs e)
        {
        ...
        private void RefreshUi(HeightMap hm)
        {
            ...
            ///////////////////////////////////////////////////////////////////////////
            // v11 new feature  - Enable building the scene on the GPU vs the CPU.   //
            ...
            // v11 is 10x faster.  Faster/better looking than any other chart, swap  //
            ...
            // Similar to above Pe3doWinUI, v11 new feature - Enable building the scene on the GPU vs the CPU.  //
            ...
            RootGrid.UpdateLayout();  // just in case events are piled up, helps guarantee rendering is as expected  
        }
        ...
        void Chart_MouseMove(object sender, PointerRoutedEventArgs e)
        {
            ...
            if (HotSpots.IsChecked == true)
            {
                ...
                Windows.Foundation.Point pt = Chart3DSurface.PeUserInterface.Cursor.LastMouseMove;
                int pX = (int)pt.X;
                int pY = (int)pt.Y;
       ...
       Color.FromArgb(255, 4, 255, 251),
       Color.FromArgb(255, 8, 255, 247),
       Color.FromArgb(255, 12, 255, 243),
       Color.FromArgb(255, 16, 255, 239),
       Color.FromArgb(255, 20, 255, 235),
       Color.FromArgb(255, 24, 255, 231),
       Color.FromArgb(255, 28, 255, 227),
       Color.FromArgb(255, 32, 255, 223),
       Color.FromArgb(255, 36, 255, 219),
       Color.FromArgb(255, 40, 255, 215),
       Color.FromArgb(255, 44, 255, 211),
       Color.FromArgb(255, 48, 255, 207),
       Color.FromArgb(255, 52, 255, 203),
       Color.FromArgb(255, 56, 255, 199),
       Color.FromArgb(255, 60, 255, 195),
       Color.FromArgb(255, 64, 255, 191),
       Color.FromArgb(255, 68, 255, 187),
       Color.FromArgb(255, 72, 255, 183),
       Color.FromArgb(255, 76, 255, 179),
       Color.FromArgb(255, 80, 255, 175),
       Color.FromArgb(255, 84, 255, 171),
       Color.FromArgb(255, 88, 255, 167),
       Color.FromArgb(255, 92, 255, 163),
       Color.FromArgb(255, 96, 255, 159),
       Color.FromArgb(255, 100, 255, 155),
       Color.FromArgb(255, 104, 255, 151),
       Color.FromArgb(255, 108, 255, 147),
       Color.FromArgb(255, 112, 255, 143),
       Color.FromArgb(255, 116, 255, 139),
       Color.FromArgb(255, 120, 255, 135),
       Color.FromArgb(255, 124, 255, 131),
       Color.FromArgb(255, 128, 255, 128),
       Color.FromArgb(255, 131, 255, 124),
       Color.FromArgb(255, 135, 255, 120),
       Color.FromArgb(255, 139, 255, 116),
       Color.FromArgb(255, 143, 255, 112),
       Color.FromArgb(255, 147, 255, 108),
       Color.FromArgb(255, 151, 255, 104),
       Color.FromArgb(255, 155, 255, 100),
       Color.FromArgb(255, 159, 255, 96),
       Color.FromArgb(255, 163, 255, 92),
       Color.FromArgb(255, 167, 255, 88),
       Color.FromArgb(255, 171, 255, 84),
       Color.FromArgb(255, 175, 255, 80),
       Color.FromArgb(255, 179, 255, 76),
       Color.FromArgb(255, 183, 255, 72),
       Color.FromArgb(255, 187, 255, 68),
       Color.FromArgb(255, 191, 255, 64),
       Color.FromArgb(255, 195, 255, 60),
       Color.FromArgb(255, 199, 255, 56),
       Color.FromArgb(255, 203, 255, 52),
       Color.FromArgb(255, 207, 255, 48),
       Color.FromArgb(255, 211, 255, 44),
       Color.FromArgb(255, 215, 255, 40),
       Color.FromArgb(255, 219, 255, 36),
       Color.FromArgb(255, 223, 255, 32),
       Color.FromArgb(255, 227, 255, 28),
       Color.FromArgb(255, 231, 255, 24),
       Color.FromArgb(255, 235, 255, 20),
       Color.FromArgb(255, 239, 255, 16),
       Color.FromArgb(255, 243, 255, 12),
       Color.FromArgb(255, 247, 255, 8),
       Color.FromArgb(255, 251, 255, 4),
       ...
       Color.FromArgb(255, 128, 0, 0)  };
        ...
        private void SliderHorizontalRotation_OnValueChanged(object sender, Microsoft.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
            if (_updatingUi)
                return;
        ...
        private void SliderZoom_OnValueChanged(object sender, Microsoft.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
            if (_updatingUi)
                return;
        ...
        private void SliderVerticalLightRotation_OnValueChanged(object sender, Microsoft.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
            if (_updatingUi)
                return;
        ...
        private void SliderHorizontalLightRotation_OnValueChanged(object sender, Microsoft.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
            if (_updatingUi)
                return;
        ...
        private void SliderVerticalRotation_OnValueChanged(object sender, Microsoft.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
            if (_updatingUi)
                return;
        ...
        private void SliderZExaggeration_OnValueChanged(object sender, Microsoft.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
        ...
        private void CenterWindowOnScreen()
        {
            ...
            int w = (int)(area.WorkArea.Width * 0.8);
            int h = (int)(area.WorkArea.Height * 0.8);
            int x = area.WorkArea.X + (area.WorkArea.Width - w) / 2;
            int y = area.WorkArea.Y + (area.WorkArea.Height - h) / 2;
            MoveWindow(Microsoft.UI.Win32Interop.GetWindowFromWindowId(AppWindow.Id), x, y, w, h, true);
        }
        ...
        private void SliderXPlane_OnValueChanged(object sender, Microsoft.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
            if (_updatingUi)
                return;
        ...
        private void Chart2DContour_PeVertScroll(object sender, ScrollEventArgs e)
        {
            ...
            // WinUI polish (also missing in the WPF original): a VERTICAL scroll of a zoomed contour changes
            // the cross-section's Z range, so refresh the 2D line chart + its translucent zoom rect to match.
            // (Horizontal scroll moves the plane along X, not the cross-section's Z extent, so it is left alone.)
            if (_bShowingPlane)
            {
                float fRange = (float)(Chart3DSurface.PeGrid.Configure.ManualMaxX - Chart3DSurface.PeGrid.Configure.ManualMinX);
                double dPos = Chart3DSurface.PeGrid.Configure.ManualMinX + (fRange * SliderXPlane.Value / 100.0F);
        ...
        {
            if (Chart2DContour.IsChartInitialized)
            {
                ...
                Chart2DContour.Invalidate(); // WinUI: control auto-updates its relative location each render
            }
        }

        private void SliderHorizontalMove_OnValueChanged(object sender, Microsoft.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
            if (_updatingUi) { return; }
        ...
        private void SliderVerticalMove_OnValueChanged(object sender, Microsoft.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
            if (_updatingUi) { return; }
